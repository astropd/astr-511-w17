...
\begin{center}
\vskip -0.1in
\scalebox{1.0}{\hskip 0.0in \includegraphics{figures/veldisp.jpg}}
\end{center}
...
\begin{slide}
\begin{center}
\scalebox{0.5}{\includegraphics{figures/Strateva_fg2.jpg}}
\end{center}
...
\begin{slide}
\begin{center}
\scalebox{0.6}{\includegraphics{figures/Strateva_fg3.jpg}}
\end{center}
...
\begin{center}
\vskip 0.1in
\scalebox{0.65}{\hskip -1.6in \includegraphics{figures/smolcic_fig1.jpg}}
...
\begin{center}
\vskip -0.7in
\scalebox{0.85}{\hskip -1.8in \includegraphics{figures/smolcic_fig21.jpg}}
...
\begin{slide}
\begin{center}
\scalebox{0.37}{\includegraphics{figures/BHcolor-mag1.jpg}}
\end{center}
\vfill
\end{slide}
%------------------------------------------------------------------------------
...
\begin{slide}
\begin{center}
\scalebox{0.6}{\includegraphics{figures/Blanton_7D.jpg}}
\end{center}
\vfill
\end{slide}
%------------------------------------------------------------------------------
...
\begin{slide}
\begin{center}
\scalebox{0.6}{\includegraphics{figures/10bandSEDgalaxies.jpg}}
\end{center}
\vfill
\end{slide}
%------------------------------------------------------------------------------
...
\begin{center}
\vskip 0.1in
\scalebox{0.65}{\hskip -1.5in \includegraphics{figures/YipFig1.jpg}}
...
\begin{center}
\vskip 0.1in
\scalebox{0.85}{\hskip -1.6in \includegraphics{figures/YipFig2.jpg}}
