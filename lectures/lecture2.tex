...
\vskip 0.1in
\scalebox{0.3}{\hskip  -3.5in \includegraphics{figures/IRAS_allsky_big.jpg}}
\vskip 0.1in
...
\begin{center}
\vskip -0.2in
\scalebox{1.0}{\hskip -0.6in \includegraphics{figures/ISM3phases.jpg}}
\end{center}
...
\begin{slide}
     \begin{center}
        \begin{minipage}{7in}
            ...
            {\scalebox{1.1}{\includegraphics{figures/plotMivsgi.pdf}}}           
        \end{minipage}
     \end{center}
    \vfill
\end{slide}
